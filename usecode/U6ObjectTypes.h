...
// (object,frame,distance to trigger,event(s),function,properties)
    ...
    { OBJ_U6_MOUSE,        255,0,USE_EVENT_SEARCH|USE_EVENT_USE,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_PLANT,        0,0,USE_EVENT_SEARCH|USE_EVENT_USE,&U6UseCode::use_container,OBJTYPE_NONE },
    ...
    { OBJ_U6_TRAP,      0,0,USE_EVENT_USE,&U6UseCode::use_trap,OBJTYPE_NONE },
