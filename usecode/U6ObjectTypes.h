...
// (object,frame,distance to trigger,event(s),function,properties)
    ...
    { OBJ_U6_DEAD_CYCLOPS, 255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_CONTAINER },
    { OBJ_U6_DEAD_GARGOYLE,255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_CONTAINER },
