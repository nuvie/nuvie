...
// (object,frame,distance to trigger,event(s),function,properties)
    ...
    { OBJ_U6_OAKEN_DOOR,   255,0,USE_EVENT_USE,&U6UseCode::use_door,OBJTYPE_DOOR },
    { OBJ_U6_WINDOWED_DOOR,255,0,USE_EVENT_USE,&U6UseCode::use_door,OBJTYPE_DOOR },
    { OBJ_U6_CEDAR_DOOR,   255,0,USE_EVENT_USE,&U6UseCode::use_door,OBJTYPE_DOOR },
    { OBJ_U6_STEEL_DOOR,   255,0,USE_EVENT_USE,&U6UseCode::use_door,OBJTYPE_DOOR },
    ...
    { OBJ_U6_CRATE,        0,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_CRATE,      255,0,USE_EVENT_USE,   &U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_BARREL,       0,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_BARREL,     255,0,USE_EVENT_USE,   &U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_CHEST,        0,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_CHEST,      255,0,USE_EVENT_USE,   &U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_SECRET_DOOR,255,0,USE_EVENT_USE|USE_EVENT_SEARCH,&U6UseCode::use_secret_door,OBJTYPE_NONE },
    { OBJ_U6_BAG,        255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_DRAWER,     255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    ...
    { OBJ_U6_DEAD_ANIMAL,255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_DEAD_BODY,  255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_DEAD_CYCLOPS, 0,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_DEAD_GARGOYLE,0,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    { OBJ_U6_REMAINS,    255,0,USE_EVENT_SEARCH,&U6UseCode::use_container,OBJTYPE_NONE },
    ...
    { OBJ_U6_RED_GATE,  1,0,USE_EVENT_PASS,&U6UseCode::enter_red_moongate,OBJTYPE_NONE }, //FIX we only want to go through frame_n 1
